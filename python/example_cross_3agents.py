...
def main():
    ...
    try:
        ...
        weather = carla.WeatherParameters(cloudiness=70,
                                          precipitation=10.0,
                                          fog_density=0.5,
        ...
        x_list_1,y_list_1,a_list_1 = loadPath('./path_data/3agents_roadshoulder/fit/path_0_agent_0.txt')
        x_list_2,y_list_2,a_list_2 = loadPath('./path_data/4agents_roadshoulder/fit/path_0_agent_0.txt')
        x_list_3,y_list_3,a_list_3 = loadPath('./path_data/4agents_roadshoulder/fit/path_0_agent_0.txt')
        ...
        while True:
            ...
            spectator.set_transform(carla.Transform(spawn_transform.location + carla.Location(x=-30,y=0,z=140),
            ...
            # if ego_vehicle_manual_1.get_transform().location.y < target_points_manual_1.location.y:
