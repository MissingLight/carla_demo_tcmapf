...
def main():
    ...
    try:
        ...
        # Moving obstacles
        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_0_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_0_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_0_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_0_agent_3.txt')
        # x_list_obs_1,y_list_obs_1,a_list_obs_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_0.txt')
        # x_list_obs_2,y_list_obs_2,a_list_obs_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_1.txt')
        # x_list_obs_3,y_list_obs_3,a_list_obs_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_2.txt')


        x_list_1,y_list_1,a_list_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_1_agent_0.txt')
        x_list_2,y_list_2,a_list_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_1_agent_1.txt')
        x_list_3,y_list_3,a_list_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_1_agent_2.txt')
        x_list_4,y_list_4,a_list_4 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_1_agent_3.txt')
        x_list_obs_1,y_list_obs_1,a_list_obs_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_0.txt')
        x_list_obs_2,y_list_obs_2,a_list_obs_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_1.txt')
        x_list_obs_3,y_list_obs_3,a_list_obs_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_2.txt')


        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_2_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_2_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_2_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_2_agent_3.txt')
        # x_list_obs_1,y_list_obs_1,a_list_obs_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_0.txt')
        # x_list_obs_2,y_list_obs_2,a_list_obs_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_1.txt')
        # x_list_obs_3,y_list_obs_3,a_list_obs_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_2.txt')


        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_3_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_3_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_3_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_3_agent_3.txt')
        # x_list_obs_1,y_list_obs_1,a_list_obs_1 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_0.txt')
        # x_list_obs_2,y_list_obs_2,a_list_obs_2 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_1.txt')
        # x_list_obs_3,y_list_obs_3,a_list_obs_3 = loadPath('./path_data/test4AgentsSmall_straight2teams_movingobs3/fit/path_movingobs_2.txt')
        ...
        # =================== Spawn Pedestrian ===================
        pedestrain_type_list = ['walker.pedestrian.0001','vehicle.diamondback.century',
                                'vehicle.bh.crossbike','vehicle.gazelle.omafiets']
        
        # spawn the pedestrain 1
        ...
        # spawn the pedestrain 2
        ego_pedestrain_bp_2 = blueprint_library.find(random.choice(pedestrain_type_list))
        # if ego_pedestrain_bp_1.has_attribute('color'):
        #     color = random.choice(ego_pedestrain_bp_1.get_attribute('color').recommended_values)
        #     ego_pedestrain_bp_1.set_attribute('color', '1, 1, 1')   
        spawn_points_pedestrain_2 = filtered_waypoints[3].transform     
        spawn_points_pedestrain_2.location.x = x_list_obs_2[0]
        spawn_points_pedestrain_2.location.y = y_list_obs_2[0]
        spawn_points_pedestrain_2.location.z += 1.6
        spawn_points_pedestrain_2.rotation.yaw = a_list_obs_2[0]
        ego_pedestrain_manual_2 = world.spawn_actor(ego_pedestrain_bp_2, spawn_points_pedestrain_2)
        actor_list.append(ego_pedestrain_manual_2)


        # spawn the pedestrain 3
        ego_pedestrain_bp_3 = blueprint_library.find(random.choice(pedestrain_type_list))
        # if ego_pedestrain_bp_1.has_attribute('color'):
        #     color = random.choice(ego_pedestrain_bp_1.get_attribute('color').recommended_values)
        #     ego_pedestrain_bp_1.set_attribute('color', '1, 1, 1')   
        spawn_points_pedestrain_3 = filtered_waypoints[3].transform     
        spawn_points_pedestrain_3.location.x = x_list_obs_3[0]
        spawn_points_pedestrain_3.location.y = y_list_obs_3[0]
        spawn_points_pedestrain_3.location.z += 1.6
        spawn_points_pedestrain_3.rotation.yaw = a_list_obs_3[0]
        ego_pedestrain_manual_3 = world.spawn_actor(ego_pedestrain_bp_3, spawn_points_pedestrain_3)
        actor_list.append(ego_pedestrain_manual_3)
        ...
        while True:
            ...
            if j > 200:
                ...
                trans_obs_2 = ego_pedestrain_manual_2.get_transform()
                if i>=len(x_list_obs_2):
                    trans_obs_2.location.x = x_list_obs_2[-1]
                    trans_obs_2.location.y = y_list_obs_2[-1]
                    trans_obs_2.rotation.yaw = a_list_obs_2[-1]
                else:
                    trans_obs_2.location.x = x_list_obs_2[i]
                    trans_obs_2.location.y = y_list_obs_2[i]
                    trans_obs_2.rotation.yaw = a_list_obs_2[i]
                ego_pedestrain_manual_2.set_transform(trans_obs_2)

                trans_obs_3 = ego_pedestrain_manual_3.get_transform()
                if i>=len(x_list_obs_3):
                    trans_obs_3.location.x = x_list_obs_3[-1]
                    trans_obs_3.location.y = y_list_obs_3[-1]
                    trans_obs_3.rotation.yaw = a_list_obs_3[-1]
                else:
                    trans_obs_3.location.x = x_list_obs_3[i]
                    trans_obs_3.location.y = y_list_obs_3[i]
                    trans_obs_3.rotation.yaw = a_list_obs_3[i]
                ego_pedestrain_manual_3.set_transform(trans_obs_3)
