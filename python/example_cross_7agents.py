...
def main():
    ...
    try:
        ...
        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/testPresidentCar7Agents/fit/path_0_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/testPresidentCar7Agents/fit/path_1_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/testPresidentCar7Agents/fit/path_2_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/testPresidentCar7Agents/fit/path_3_agent_6.txt')

        ##############  testPresidentCar7Agents Small IROS #####################
        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_0_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_1_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_2_agent_6.txt')

        # x_list_1,y_list_1,a_list_1 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_0.txt')
        # x_list_2,y_list_2,a_list_2 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_1.txt')
        # x_list_3,y_list_3,a_list_3 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_2.txt')
        # x_list_4,y_list_4,a_list_4 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_3.txt')
        # x_list_5,y_list_5,a_list_5 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_4.txt')
        # x_list_6,y_list_6,a_list_6 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_5.txt')
        # x_list_7,y_list_7,a_list_7 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_3_agent_6.txt')

        x_list_1,y_list_1,a_list_1 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_0.txt')
        x_list_2,y_list_2,a_list_2 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_1.txt')
        x_list_3,y_list_3,a_list_3 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_2.txt')
        x_list_4,y_list_4,a_list_4 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_3.txt')
        x_list_5,y_list_5,a_list_5 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_4.txt')
        x_list_6,y_list_6,a_list_6 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_5.txt')
        x_list_7,y_list_7,a_list_7 = loadPath('./path_data/iros_final_paper_demo/testPresidentCar7AgentsSmall/fit/path_4_agent_6.txt')
